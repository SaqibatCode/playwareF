                ...
                <div class="col-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-subtitle mb-2">Please Provide Your Accurate Detail For Verification, Your Account
                                will
                                get active in 24 to 48 Hours after verification, for more details you can read <a
                                    href="#">Term & Conditions</a></p>
                            <p class="card-subtitle mb-4">If you are looking to create Enterprise/Corporate account please
                                <a href="#">contact our support</a>
                            </p>

                            <form action="{{ route('auth.verifySeller') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    ...
                                    <select name="AccountType" id="accountType" class="form-control">
                                        ...
                                        <option value="Shopkeepr">Shop Keeper</option>
                                    </select>
                                    @error('AccountType')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div id="individualSeller" style="display: none;">
                                    <div class="form-group">
                                        <label>Your CNIC (13 Digits Computerised National Identity Card)</label>
                                        <input type="text" name="cnicNumber" class="form-control"
                                            placeholder="XXXXX-XXXXXX-X" value='{{ old('value') }}'>
                                        @error('cnicNumber')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div id="shopSeller" style="display: none;">
                                    <div class="form-group">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-subtitle mb-2">Provide necessary documentation as specified (ID, proof of
                                address,
                                etc.).</p>
                            <p class="card-subtitle mb-2">Follow any additional steps outlined in the registration process.
                            </p>
                            <p class="card-subtitle mb-2">Submit the completed registration form and documents through the
                                designated method.</p>
