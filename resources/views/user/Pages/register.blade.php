        ...
        <div class="w-11/12 p-4 sm:p-12 bg-white sm:w-8/12 md:w-1/2 lg:w-5/12 border shadow-lg rounded-md">
            ...
            <form class="mt-6" enctype="multipart/form-data">
                ...
                <input id="dob" type="date" name="dob"
                    class="block w-full p-3 mt-2 text-gray-700 bg-gray-200 appearance-none focus:outline-none focus:bg-gray-300 focus:shadow-inner rounded-md"
                    required />
                <label for="shop-address" class="block mt-2 text-xs font-semibold text-gray-600 uppercase">Shop
                    Address</label>
                <input id="shop-address" type="text" name="shop-address" placeholder="ABC Street, Karachi"
                    class="block w-full p-3 mt-2 text-gray-700 bg-gray-200 appearance-none focus:outline-none focus:bg-gray-300 focus:shadow-inner rounded-md"
                    required />
                <label for="shop-pictures" class="block mt-2 text-xs font-semibold text-gray-600 uppercase">Shop
                    Pictures/Business Card Pictures</label>
                <input id="shop-pictures" type="file" multiple name="shop-pictures"
                    class="block w-full p-3 mt-2 text-gray-700 bg-gray-200 appearance-none focus:outline-none focus:bg-gray-300 focus:shadow-inner rounded-md"
                    required />
                <label for="cnic" class="block mt-2 text-xs font-semibold text-gray-600 uppercase">CNIC</label>
                <input id="cnic" type="number" minlength="15" maxlength="15" name="cnic"
                    placeholder="42201-5678902-5"
                    class="block w-full p-3 mt-2 text-gray-700 bg-gray-200 appearance-none focus:outline-none focus:bg-gray-300 focus:shadow-inner rounded-md remove-number-arrows"
                    required />

                <div class="block sm:flex justify-between gap-3">
                    <span class="w-full sm:w-1/2">
                        <label for="cnic-picture-front"
                            class="block mt-2 text-xs font-semibold text-gray-600 uppercase">
                            CNIC Picture (Front)</label>
                        <input id="cnic-picture-front" type="file" name="cnic-picture-front"
                            class="block w-full p-3 mt-2 text-gray-700 bg-gray-200 appearance-none focus:outline-none focus:bg-gray-300 focus:shadow-inner rounded-md"
                            required />
                    </span>
                    <span class="w-full sm:w-1/2">
                        <label for="cnic-picture-back"
                            class="block mt-2 text-xs font-semibold text-gray-600 uppercase">
                            CNIC Picture (Back)</label>
                        <input id="cnic-picture-back" type="file" name="cnic-picture-back"
                            class="block w-full p-3 mt-2 text-gray-700 bg-gray-200 appearance-none focus:outline-none focus:bg-gray-300 focus:shadow-inner rounded-md"
                            required />
                    </span>
                </div>
