...
<main class="mt-11">
    ...
    <button
        ...
        <svg class="w-6 h-6" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 384 512"
    ...
    <section class="px-4 pb-12">
        <div class="container mx-auto">
            ...
            <div id="productDiv1"
                ...
                <!-- DYNAMIC PRODUCTS FROM mapProduct.JS -->
        ...
        <div class="container mx-auto">
            ...
            <div class="flex flex-wrap gap-2 justify-between items-center p-4 sm:p-5 mb-8 border-b bg-gray-100">
                ...
                <div class="">
                    <ul class="flex flex-wrap gap-x-6">
                        ...
                        <li><a href="#" class="transition-all duration-300 hover:text-skin-secondary">iPad</a></li>
                        <li><a href="#" class="transition-all duration-300 hover:text-skin-secondary">Samsung</a>
                        </li>
                        <li><a href="#" class="transition-all duration-300 hover:text-skin-secondary">Sony</a></li>
                        <li><a href="#" class="transition-all duration-300 hover:text-skin-secondary">View All</a>
                        </li>
                    </ul>
                </div>
            ...
            <div id="productDiv2"
                ...
                <!-- <div class="max-w-60 border rounded-md overflow-hidden p-4">
                    ...
                    <div class="flex flex-col gap-2">
                        <a href="/product-page" class="text-xs sm:text-sm text-skin-gray font-bold">Apple MacBook Air Retina
                            13.3-Inch
                            Laptop </a>
