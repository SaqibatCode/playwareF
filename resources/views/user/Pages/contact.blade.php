...
<main class="mt-11">
    ...
    <section class="container mx-auto px-4 py-12 flex flex-col lg:flex-row gap-8">
        <div class="lg:w-6/12 p-4 text-skin-primary bg-skin-inverted rounded-md">
            <h3 class="text-2xl sm:text-4xl font-bold mb-8 text-center">Call or Send Email to Us</h3>
            <h2 class="text-xl sm:text-3xl mb-6 sm:mb-8 text-center flex justify-center items-center gap-2 group">
                ...
                <a href="tel:+9233322213141">+92 333 22213141</a>
            </h2>
            <h2 class="text-xl sm:text-3xl mb-6 sm:mb-8 text-center flex justify-center items-center gap-2 group">
                <svg class="text-skin-secondary transition-all duration-300 group-hover:rotate-12 group-hover:scale-110"
                ...
                <a href="mailto:store@playware.pk">store@playware.pk</a>
            </h2>
            <p>
                Within our markets, millions of people around the world connect, both online and offline, to
                make,
                sell
                and buy unique goods. We also offer a wide range of Seller Services and tools that help creative
                entrepreneurs start, manage and scale their businesses. Our mission is to reimagine commerce in
                ways
                that build a more fulfilling and lasting world, and we’re committed to using the power of
                business
                to
            ...
            <form action="">
                <div class="flex flex-col gap-8">
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div class="floating-label-div">
                            <input type="email" name="email" id="email" class="input-form peer"
                                placeholder="" required>
                    ...
                    <div class="floating-label-div">
                        <input type="text" name="number" id="number" class="input-form peer"
                            placeholder="" required>
                        <label htmlFor="number" class="floating-label">Number *</label>
                    </div>

                    <div class="floating-label-div">
                        <input type="text" name="subject" id="subject" class="input-form peer"
                            placeholder="">
                    ...
                    <button class="rounded-md p-2  font-bold transition-all duration-300 bg-skin-inverted text-skin-primary hover:text-skin-inverted hover:bg-skin-primary">Submit</button>
                </div>
            </form>
