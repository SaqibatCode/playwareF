...
<body onload="addHeaderAndFooter()">
    ...
    <header id="header" class="bg-skin-primary/90 w-full backdrop-blur-sm z-50 fixed top-0 left-0"
    ...
    <footer class="flex flex-col items-center bg-skin-secondary text-center text-skin-inverted">
        <div class="container px-6 pt-6">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4">
                <div class="mb-6 text-start mx-auto">
...
<script src="{{ asset('scripts/mapProduct.js') }}"></script>
<script src="https://code.jquery.com/jquery-3.7.1.min.js"
    integrity="sha256-/JqT3SQfawRcv/BIHPThkBvs0OEvtFFmqPF/lYI/Cxo=" crossorigin="anonymous"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/modernizr/2.8.3/modernizr.min.js"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/2.1.3/jquery.min.js"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/slick-carousel/1.8.1/slick.min.js"></script>
<script src="scripts/homePageSlider.js"></script>
