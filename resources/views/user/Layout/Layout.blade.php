    ...
    <header id="header" class="bg-skin-gray/90 w-full backdrop-blur-sm z-50 fixed top-0 left-0"
        ...
        <nav class="container mx-auto flex justify-between items-center py-1 px-4 lg:px-0">
            ...
            <ul class="hidden items-center gap-6 xl:gap-8 min-[992px]:flex">
                ...
                <li onmouseover="toggleSubcategoryMegaMenu()" class="nav-link"><a href="{{ route('shop') }}">All
                        Products</a>
                </li>
                <li onmouseover="toggleSubcategoryMegaMenu()" class="nav-link"><a
                        href="{{ route('shop-single', '1') }}">Laptops</a>
                </li>

                <li onmouseover="toggleSubcategoryMegaMenu()" class="nav-link"><a
                        href="{{ route('shop-single', '1') }}">Gaming
                        Pcs</a>
                </li>
                <li onmouseover="toggleSubcategoryMegaMenu()" class="nav-link"><a
                        href="{{ route('shop-single', '1') }}">Monitors</a>
                </li>
                <li onmouseover="toggleSubcategoryMegaMenu()" class="nav-link"><a
